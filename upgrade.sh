...
scp "$PWD/build/Esp32Ansluta.bin" root@debian.fritz.box:/tmp/esp32
...
docker run --init -it --rm --entrypoint sh efrecon/mqtt-client -c "pub -h debian.fritz.box -t 'devices/6055f97c2af8/\$update' -m true ; sub -h debian.fritz.box -t 'devices/6055f97c2af8/\$state' -C 3 -R -v"
